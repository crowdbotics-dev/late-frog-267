"""
Django settings for late_frog_267 project.
...
ROOT_URLCONF = 'late_frog_267.urls'
...
WSGI_APPLICATION = 'late_frog_267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_frog_267 API",
    "DESCRIPTION": "API documentation for late_frog_267 App",
    "VERSION": "v1",
}
